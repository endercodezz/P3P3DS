...
#define KIRK_CMD_PRIV_SIGN_CHECK 0xA
#define KIRK_CMD_SHA1_HASH 0xB
#define KIRK_CMD_ECDSA_GEN_KEYS 0xC
#define KIRK_CMD_ECDSA_MULTIPLY_POINT 0xD
#define KIRK_CMD_PRNG 0xE
#define KIRK_CMD_15 0xF
#define KIRK_CMD_ECDSA_SIGN 0x10
#define KIRK_CMD_ECDSA_VERIFY 0x11
